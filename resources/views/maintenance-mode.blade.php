...
<head>
	<title>MAINTENANCE MODE | CleanLab Template</title>
	...
	<div id="content">
		<div class="maintenance-top">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h1 class="center mbottom15">Maintenance Mode</h1>
						<p class="center size20 weight300">This website is currently under going maintenance.</p>
					</div>
				</div>
			</div>
		</div>
