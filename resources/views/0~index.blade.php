...
<head>
	<title>HOME | CleanLab Template</title>
            ...
            <div class="col-sm-6">
            	<form>
                    <select id="headers" class="show-menu-arrow selectpicker" value="GO">
                        ...
                        <option value="header5">Style 5</option>
                        <option value="header6">Style 6 (New)</option>
                    </select>
                </form>  
            </div>
            <div class="col-sm-6">
            	<form>
            		<select id="footers" class="show-menu-arrow selectpicker" value="GO">
                        ...
                        <option value="footer-style1">Style 1</option>
                        <option value="footer-style2">Style 2</option>
                        <option value="footer-style3">Style 3</option>
                    </select> 
            	</form>
            </div>
        </div>
...
<div id="page-wrapper">
				...
				<ul>	
					...
					<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
						...
						<div class="tp-caption sfb firstslide"
							...
							data-endspeed="300"
							style="z-index: 2"><img src="images/slideshow/layer1.png" alt="" width="435" height="411">
						</div>
						<!-- LAYER NR. 2 -->
	...
	<div id="content">
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-5 left">
						<h2>We conceive, design and produce digital content and integrated experiences for web</h2>
	    ...
	    <div id="from-blog">
			<div class="container">
				<h2 class="section-title center mbottom50">From the Blog</h2>
				<div class="row">
					<div class="col-sm-4">
						<span class="blog-date">10/07</span>
						<div class="blog-boxes">
							<h3>Elit non mi porta gravida at eget metus. Fusce dapibus.</h3>
							<p class="mbottom15">Posted by <a href="#">Admin</a></p>
							<p class="mbottom15">Donec ullamcorper nulla non ms ac is mollis, est non commodo luctus, nisi ula, eget lacinia odio sem nec elit. Aene ndum nulla sed. Donec ullamcorper nulla non metus.</p>
							<a href="#">More info</a>
							<span class="icon-heart2 tcolor fright"><b>17</b></span>
						</div>
					</div>
					<div class="col-sm-4">
						<span class="blog-date">12/07</span>
						<div class="blog-boxes">
							<h3>Elit non mi porta gravida at eget metus. Fusce dapibus.</h3>
							<p class="mbottom15">Posted by <a href="#">Admin</a></p>
							<p class="mbottom15">Donec ullamcorper nulla non ms ac is mollis, est non commodo luctus, nisi ula, eget lacinia odio sem nec elit. Aene ndum nulla sed. Donec ullamcorper nulla non metus.</p>
					...
					<div class="col-sm-4">
						<span class="blog-date">15/07</span>
						<div class="blog-boxes">
							<h3>Elit non mi porta gravida at eget metus. Fusce dapibus.</h3>
							<p class="mbottom15">Posted by <a href="#">Admin</a></p>
							<p class="mbottom15">Donec ullamcorper nulla non ms ac is mollis, est non commodo luctus, nisi ula, eget lacinia odio sem nec elit. Aene ndum nulla sed. Donec ullamcorper nulla non metus.</p>
		    ...
		    <div class="container">
		    	<div class="row">
		    		<div class="col-sm-12 relative">
		    			<h2 class="section-title">Meet Our Team of Best Professionals</h2>
		    			<div id="our-team">
		...
		<div class="buy">
			<div class="container">
				<div class="row">
					<div class="col-sm-9">
						<h2>This is <span>The Best</span> Multi Purpose Wordpress Theme</h2>
						<h5>It’s Suitable for Corporate, Creative, Personal, Noncommercial Needs</h5>
					</div>
					<div class="col-sm-3 center">
						<a href="http://themeforest.net/item/cleanlab-multiporpose-html5-template/8570208/?ref=LorThemes" rel="nofollow" target="_blank" class="btn btn-default btn-default2">buy now</a>
					</div>
				</div>
			</div>
		</div><!-- end buy section-->
...
<script>
	...
	ga('create','UA-55690359-1');ga('send','pageview');
</script>
</body>
</html>