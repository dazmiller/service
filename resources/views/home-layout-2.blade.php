...
<head>
	<title>HOME LAYOUT 2 | CleanLab Template</title>
	...
	<link rel="stylesheet" type="text/css" href="css/masterslider-style.css" />
	...
	<div id="content">
			...
			<div class="row">
				<div class="col-sm-12">
					<div id="subscribe" class="center mbottom80">
						<h2 class="section-title mbottom5"><span class="tcolor">CleanLab</span> is Multi Purpose & Responsive</h2>
		...
		<div id="amazing">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-6">
						<img src="images/middle-browser.png" alt="" class="img-responsive" />
					</div>
		...
		<div class="video-presentation">
			<div class="video-overlay">
				<div class="play-button">
					<a href="http://vimeo.com/14428901/" title="Video Presentation">
						<i class="icon-play2"></i>
					</a>
				</div>
				<h2>Checktout this amazing video</h2>
				<h2>Made for the company presentation video</h2>
			</div><!-- end video-overlay -->
		</div><!-- end video-presentation -->
	    ...
	    <div id="designed">
	    	<div class="container">
	    		<div class="row">
	    			<div class="col-sm-12 center">
	    				<h2 class="section-title mbottom50 ptop50">Designed with simplicity</h2>
	    				<div class="ms-caro3d-template">
			                <!-- masterslider -->
			                <div class="master-slider ms-skin-default" id="masterslider2">
			                    <div class="ms-slide">
			                        <img src="images/browsers/browser1.png" data-src="images/designed/browser1.png" width="460" height="272" alt=""/> 
			                    </div>
			                    <div class="ms-slide">
			                        <img src="images/browsers/browser2.png" data-src="images/designed/browser2.png" width="460" height="272" alt=""/>    
			                    </div>
			                    <div class="ms-slide">
			                        <img src="images/browsers/browser3.png" data-src="images/designed/browser3.png" width="460" height="272" alt=""/>   
			                    </div>
			                </div>
			                <!-- end of masterslider -->
			        	</div>
