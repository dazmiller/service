...
<head>
	<title>Coming Soon | CleanLab Template</title>
...
<div id="page-wrapper" class="coming-soon">
	<div id="header">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
	...
	<div id="content">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h2 class="section-title center">We are working hard to finish our amazing new website!</h2>
					<h3 class="center mbottom30">We are almost done...</h3>
					<div id="countdown" class="row">
						<div class="col-sm-12 count-widget">
							<ul class="counter reset-list">
						      <li>
					...
					<div class="subscribe center mbottom80">
						<form action="http://lorthemes.us8.list-manage1.com/subscribe/post-json?u=42795504a248e486766e563b9&amp;id=f766078320&amp;c=?" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
							...
							<button class="btn2 btn-2" type="submit" name="subscribe" id="mc-embedded-subscribe">Get notified</button>
						</form>	
						<div id="notification_container"></div>
					</div>
					<div class="under-social center mbottom50">
						<ul reset-list>
							<li>
								<a href="#">
									<span class="icon-facebook"></span>
...
<script type= "text/javascript"SRC="js/comingsoon-countdown.js"></script>
